<template>
  <!-- rail -->
  <v-navigation-drawer elevation="2" expand-on-hover rail :close-delay="2000">
    ...
    <v-list v-model:opened="open" color="primary" density="compact" variant="plain" :lines="false" nav>
      ...
      <v-list-group value="Users">
        ...
        <v-list-item v-for="([title, icon, to], i) in cruds" :key="i" :value="to" :to="to" :title="title">
        </v-list-item>
      </v-list-group>
      ...
      <v-list-group value="Users2">
        ...
        <v-list-item v-for="([title, icon, to], i) in cruds2" :key="i" :value="to" :to="to" :title="title">
        </v-list-item>
      </v-list-group>
    </v-list>
  </v-navigation-drawer>
